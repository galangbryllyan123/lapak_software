...
<html lang="en">
      <head>
      <title>Karan &mdash; Pemesanan Desain semua plaform</title>
      <meta charset="utf-8">
          ...
          <div class="col-md-12" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="row justify-content-center mb-4">
              <div class="col-md-8 text-center">
                ...
                <p class="lead mb-5">Kami Membuat software terbaik</p>
              </div>
            </div>
      ...
      <div class="container">
          ...
          <div class="col-md-12">
            <div class="row">
              <div class="col-md-7">
                ...
                <p>Membangun Website yang menyediakan jasa pembuatan di bidang software </p>
              </div>
        ...
        <div class="row pt-5 mt-5 text-center">
          <div class="col-md-12">
            ...
            Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="icon-heart" aria-hidden="true"></i> by <a href="https://www.instagram.com/kanggalang76" target="_blank" >seno kidal</a>
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
            </div>
          </div>
