          ...
          <div class="col-12 bg-black w-100 ft-feature-1-content">
            <div class="row align-items-center">
              <div class="col-lg-5">
                <div class="h-100">
                  <div class="mb-5 d-flex align-items-center">
                    ...
                    <h2>Selamat Datang Ke Website Penjualan semua plaform bidang software</h2>
                  </div>
              ...
              <div class="col-lg-3 ml-auto">
                <div class="mb-5">
                  <h3 class="d-flex align-items-center"><span class="icon icon-phonelink mr-2"></span><span>mobile</span></h3>
                  <p>Letakkan Kata2</p>
                  <p><a href="<?=base_url()?>home/project">Lihat Desain</a></p>
                </div>

                <div>
                  <h3 class="d-flex align-items-center"><span class="icon icon-extension mr-2"></span><span>ios</span></h3>
                  <p>Letakkan Kata2</p>
                  <p><a href="<?=base_url()?>home/project">Lihat Desain</a></p>
                </div>
              ...
              <div class="col-lg-3">
                <div class="mb-5">
                  <h3 class="d-flex align-items-center"><span class="icon icon-format_paint mr-2"></span><span>website</span></h3>
                  <p>Letakkan Kata2</p>
                  <p><a href="<?=base_url()?>home/project">Lihat Desain</a></p>
                </div>
      ...
      <div class="container">
        <div class="row mb-5 justify-content-center">
          <div class="col-md-8 text-center">
            <h2 class="text-black h1 site-section-heading text-center">Project</h2>
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-12 text-center mt-5">
            <a href="<?=base_url()?>home/project" class="btn btn-primary btn-md">Lihat Semua Project</a>
          </div>
