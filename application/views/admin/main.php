		<div class="row small-spacing">
					...
					<div class="card-content">
						<form method="post" id="myform" name="myform" enctype="multipart/form-data">
							...
							<div class="form-group" id="jenis_undangan" style="display: none">
								<label for="exampleInputFile">Jenis website</label>
								<select class="form-control" name="jenis_undangan" id="undangan">
									<option value="">-Sila Pilih Jenis website</option>
									<option value="1">codenginter</option>
			...
			<div class="col-lg-8 col-xs-12">
				<div class="box-content card white">
					<h4 class="box-title">Form Project</h4>
					<div class="tab">
            <button class="tablinks" onclick="openCity(event, 'undangantab')" id="defaultOpen">website</button>
            <button class="tablinks" onclick="openCity(event, 'kartu_nama')">mobile</button>
            <button class="tablinks" onclick="openCity(event, 'sepanduk')">ios</button>
          </div>
									...
									<div class="row small-spacing">
										...
										<div class="col-lg-3 col-md-6 col-xs-12">
											<center>
												...
												<p>Harga : Rp. <?=number_format($keterangan->harga)?> / source <br>Upload : <?=$value->tanggal_upload?></p>
