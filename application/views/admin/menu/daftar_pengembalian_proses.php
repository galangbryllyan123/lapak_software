					...
					<?php  
						...
						if ($value1->kategori == 1) {
							...
							if ($ket_pembelian->jenis_kertas == '4000') {
				                $jenis_kertas = " custom sendiri | Rp. 4,000 / 1 source";
			              	}elseif ($ket_pembelian->jenis_kertas == '3000') {
				                $jenis_kertas = "remote | Rp. 3,000 / 1 source";
			              	}elseif ($ket_pembelian->jenis_kertas == '1000') {
			                	$jenis_kertas = "random | Rp. 1,000 / 1 source";
			              	}
						}elseif ($value1->kategori == 2) {
							$kategori = "Kartu Nama";
							if ($ket_pembelian->jenis_kertas == '25000') {
				                $jenis_kertas = "custom sendiri | Rp. 25,000 / 1 source";
			              	}elseif ($ket_pembelian->jenis_kertas == '1000') {
				                $jenis_kertas = "remote | Rp. 1,000 / 1 source";
			              	}elseif ($ket_pembelian->jenis_kertas == '500') {
				                $jenis_kertas = "random | Rp. 500 / 1 source";
			              	}
					...
					<?php if ($value1->kategori == 3): ?>
						<div class="card-content">
							<div class="form-horizontal">
								...
								<div class="form-group">
									<label for="inputEmail3" class="col-sm-3 control-label">Jenis website</label>
									<div class="col-sm-9">
                ...
                if( is_dir($dir) === true ){ ?>
                	...
                	<?php
							...
							<?php if ($value1->kategori == 1 and $ket_produk->undangan == 2): ?>
								...
								<div class="form-group">
									<label for="inputEmail3" class="col-sm-3 control-label">plafrom</label>
									<div class="col-sm-9">
								...
								<div class="form-group">
									<label for="inputEmail3" class="col-sm-3 control-label">waktu yang di kerjakan</label>
									<div class="col-sm-9">
