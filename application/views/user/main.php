        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="form-group">
              <div class="tab">
                <button class="tablinks" onclick="openCity(event, 'undangan')" id="defaultOpen">website</button>
                <button class="tablinks" onclick="openCity(event, 'kartu_nama')">Mobile</button>
                <button class="tablinks" onclick="openCity(event, 'spanduk')">Ios</button>
                 <a href="<?=base_url()?>user/desain_sendiri"><button>Desain plafrom</button></a>
              </div>
            </div>
          </div>
            ...
            <div class="row mb-5">
              ...
              <div class="col-md-6 col-lg-3 mb-4 mb-lg-4">
                <div class="h-entry">
                  ...
                  <p>Harga : Rp. <?=number_format($keterangan->harga)?> / source </p>
