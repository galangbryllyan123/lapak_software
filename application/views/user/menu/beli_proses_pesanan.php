              ...
              <div class="h-entry">
                <center>
                  <?php if ($value1->kategori == 2): ?>
                    <h3><a href="<?=base_url()?>try2/sini/<?=$this->uri->segment(4)?>" target="_blank">Lihat Contoh Desain</a></h3> 
                  <?php elseif ($value1->kategori == 1 and $ket_produk->undangan == 1): ?>
                    <h3><a href="<?=base_url()?>try2/sini/<?=$this->uri->segment(4)?>" target="_blank">Lihat Contoh Desain</a></h3>                 
                  <?php elseif ($value1->kategori == 1 and $ket_produk->undangan == 2): ?>
                    <h3><a href="<?=base_url()?>try2/sini/<?=$this->uri->segment(4)?>" target="_blank">Lihat Contoh Desain</a></h3>
                  <?php else: ?>
                    <img src="<?=base_url($ket_produk->img)?>" width="50%" height="50%">
                  <?php endif ?>
                  


                <!-- <h2 class="font-size-regular"><a href="#">Warehousing Your Packages</a></h2> -->
                <div class="meta mb-4"><span class="mx-2"></span><b><?=$kategori?></b> / Upload &bullet; <?=$value1->tanggal_upload?><span class="mx-2">&bullet;</span> <br><b>Harga Per Desain</b> : Rp. <?=number_format($ket_produk->harga)?><br><b>Status : <i><?=$status?></i></b></div></center>
              </div> 
            </div>
          </div> 
        </div>
          ...
          <div class="col-md-7">
            ...
            <div class="row form-group">
              ...
              <div class="col-md-12">
                ...
                <input type="Text" class="form-control" value="Rp. <?=number_format($ket_produk->harga)?> " disabled=""> 
                <?php endif ?> 
                <?php if ($value1->kategori == 3): ?>
                <input type="text"  class="form-control" value="Rp. <?=number_format($ket_produk->harga)?>" disabled="">   
                <?php endif ?>
            ...
            <div class="row form-group">
              ...
              <div class="col-md-12">
                ...
                <?php if ($value1->kategori == 3): ?>
                <!-- <input type="Text"  class="form-control" value="Rp. <?=number_format(($ket_pembelian->lebar * 12500)  + ($ket_pembelian->panjang * 12500) + $ket_produk->harga)?> / <?=$ket_pembelian->jumlah_kertas?> source" disabled="">  -->
            ...
            <form  method="post" id="ini_formnya">
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <input class="form-control"  type="file" id='files' name="files[]" onchange="previewImage1();" multiple <?php if ( is_dir($dir) === true): ?>disabled=""<?php endif ?> <?php if ($value->id_transaksi >= 2): ?> disabled="" <?php endif ?>>
                </div>
              </div>
              ...
              <?php  
                if ($value1->kategori != 3) { ?>
                  <div class="row form-group">
                    <div class="col-md-12">
                      <label class="text-black" for="email">Jenis ui dan ux</label> 
                      <select class="form-control" name="jenis_kertas" id="jenis_kertas" required <?php if ($value->id_transaksi >= 2): ?> disabled="" <?php endif ?>>
                        <option value="" disabled="">-Silahkan Pilih Jenis ui dan ux</option>
                          <?php  
                            if ($value1->kategori == 1) { ?>
                        <option value="4000" <?php if ($ket_pembelian->jenis_kertas == "4000"): ?> selected="" <?php endif ?>>custom sendiri | Rp. 4,000 / 1 source</option>
                        <option value="3000" <?php if ($ket_pembelian->jenis_kertas == "3000"): ?> selected="" <?php endif ?>>remote | Rp. 3,000 / 1 source</option>
                        <option value="1000" <?php if ($ket_pembelian->jenis_kertas == "1000"): ?> selected="" <?php endif ?>>random | Rp. 1,000 / 1 source</option>      
                            <?php }elseif ($value1->kategori == 2) { ?>
                        <option value="25000" <?php if ($ket_pembelian->jenis_kertas == "25000"): ?> selected="" <?php endif ?>>custom sendiri | Rp. 4,000 / 1 source</option>
                        <option value="1000" <?php if ($ket_pembelian->jenis_kertas == "1000"): ?> selected="" <?php endif ?>>remote | Rp. 3,000 / 1 source</option>
                        <option value="500" <?php if ($ket_pembelian->jenis_kertas == "500"): ?> selected="" <?php endif ?>>random | Rp. 1,000 / 1 source</option>      
                            <?php }
                          ?>
              ...
              <?php  
                if ($value1->kategori == 1) { ?>
                  <div class="row form-group">
                    <div class="col-md-12">
                      <label class="text-black" for="email">kombinasi</label> 
                  ...
                  <div class="row form-group">
                    <div class="col-md-6 mb-3 mb-md-0">
                      <label class="text-black" for="fname">kombinasi</label>
                      <input type="text" name="panjang" placeholder="Isikan kombinasi | source kombinasi" title="Cth : 2 (2 meter panjang) / 2.5 (2.5 meter panjang)" class="form-control" required="" id="panjang" minlength="1" maxlength="3" value="<?=$panjang_nya?>" <?php if ($value->id_transaksi >= 2): ?> disabled="" <?php endif ?>>
                    </div>
                    <div class="col-md-6">
                      <label class="text-black" for="fname">kombinasi</label>
                      <input type="text" name="lebar" placeholder="Isikan kombinasi | source kombinasi" title="Cth : 2 (2 meter lebar) / 2.5 (2.5 meter lebar)" class="form-control" required="" id="lebar" minlength="1" maxlength="3" value="<?=$lebar_nya?>" <?php if ($value->id_transaksi >= 2): ?> disabled="" <?php endif ?>>
                    </div>
                    <div class="col-md-12">
                      <p style="font-style: 3px;"><i>Keterangan : kombinasi = <b>Rp . 25,000</b></i></p>
                    </div>
                  </div>
                      <?php
              ...
              <?php  
                if ($kategori == 'Undangan Nikah') { ?>
                  ...
                  <div class="row form-group">
                    <div class="col-md-12">
                      <label class="text-black" for="email">pajak</label> 
                      <input type="text" name="akad" placeholder="pajak" title="ket pajak progammer" class="form-control"  required="" value="<?=$ket_pembelian->akad?>" <?php if ($value->id_transaksi >= 2): ?> disabled="" <?php endif ?>>
                    </div>
                  </div>

                  <div class="row form-group">
                    <div class="col-md-12">
                      <label class="text-black" for="email">Revisi</label> 
                      <input type="text" name="resepsi" placeholder="tidak melayani" title="tidak melayani" class="form-control"  required="" value="<?=$ket_pembelian->resepsi?>" <?php if ($value->id_transaksi >= 2): ?> disabled="" <?php endif ?>>
                    </div>
                  </div>
                  ...
                  <div class="row form-group">
                    <div class="col-md-12">
                      <label class="text-black" for="email">Tanggal</label> 
                      <input type="date" name="tanggal" placeholder="Tanggal Aqiqah Berlangsung" title="Tanggal Aqiqah Berlangsung" class="form-control"  required="" value="<?=$ket_pembelian->tanggal?>" <?php if ($value->id_transaksi >= 2): ?> disabled="" <?php endif ?>>
                    </div>
                  </div>
                  ...
                  <div class="row form-group">
                    <div class="col-md-6 mb-3 mb-md-0">
                      ...
                      <input type="time" name="waktu" placeholder="Waktu Berlangsung Aqiqag" title="Waktu Berlangsung Aqiqah" class="form-control" required="" value="<?=$ket_pembelian->waktu?>" <?php if ($value->id_transaksi >= 2): ?> disabled="" <?php endif ?>>
                    </div>
                    <div class="col-md-6">
