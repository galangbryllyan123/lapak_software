            ...
            <div class="col-md-12 col-lg-12">
              <div class="h-entry">
                <center>
                  ...
                  <div class="meta mb-4"><span class="mx-2"></span><b><?=$kategori?></b> / Upload &bullet; <?=$value1->tanggal_upload?><span class="mx-2">&bullet;</span> <br><b>Harga Per Desain</b> : Rp. <?=number_format($ket_produk->harga)?><br><b>Status : <i><?=$status?></i></b></div>
                </center>
              </div> 
            </div>
          </div> 
          ...
          <div class="col-md-7">
            ...
            <div class="row form-group">
              ...
              <div class="col-md-12">
                ...
                <input type="Text" id="email" class="form-control" value=" seno kidal" disabled="">
              </div>
            </div> -->
            ...
            <div class="row form-group">
              ...
              <div class="col-md-12">
                ...
                <input type="Text" id="email" class="form-control" value="Rp. <?=number_format($ket_pembelian->jenis_kertas + $ket_produk->harga)?> / 1 pcs" disabled=""> 
                <?php endif ?> 
                <?php if ($value1->kategori == 3): ?>
                <input type="text" id="email" class="form-control" value="Rp. <?=number_format(($ket_pembelian->lebar * 12500)  + ($ket_pembelian->panjang * 12500) + $ket_produk->harga)?> / 1 pcs" disabled="">   
                <?php endif ?>
              </div>
            </div>
            ...
            <div class="row form-group">
              ...
              <div class="col-md-12">
                ...
                <?php if ($value1->kategori == 3): ?>
                <input type="Text" id="email" class="form-control" value="Rp. <?=number_format(($ket_pembelian->lebar * 12500)  + ($ket_pembelian->panjang * 12500) + $ket_produk->harga)?> / <?=$ket_pembelian->jumlah_kertas?> pcs" disabled=""> 
                <?php endif ?>
                <?php if ($value1->kategori != 3): ?>
                <input type="Text" id="email" class="form-control" value="Rp. <?=number_format(($ket_pembelian->jenis_kertas + $ket_produk->harga) * $ket_pembelian->jumlah_kertas)?> / <?=$ket_pembelian->jumlah_kertas?> pcs" disabled="">   
                <?php endif ?>
             ...
             <div class="row form-group">
              ...
              <div class="col-md-12">
                ...
                <?php if ($value1->kategori == 3): 
                          ...
                          // }
                  ?>
                <input type="Text" id="email" class="form-control" value="Rp. <?=number_format($ket_pembelian->lebar * $ket_pembelian->panjang * 12500 * $ket_pembelian->jumlah_kertas + $ket_produk->harga + substr($data_pembeli['no_telpon'], -3))?>" disabled="">   
                <?php endif ?> 
                <?php if ($value1->kategori != 3): ?>
                <input type="Text" id="email" class="form-control" value="Rp. <?=number_format(($ket_pembelian->jenis_kertas * $ket_pembelian->jumlah_kertas ) + $ket_produk->harga + substr($data_pembeli['no_telpon'], -3))?>" disabled="">  
                <?php endif ?>
