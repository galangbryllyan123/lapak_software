        ...
        <div class="row">
          <div class="col-md-7">
            ...
            <div class="row form-group">
              ...
              <div class="col-md-12">
                <label class="text-black" for="email">Harga source</label> 
                <?php if ($value->kategori == 3): ?>
               
                <input type="Text"  class="form-control" value="Rp. <?=number_format($ket_pembelian->lebar * $ket_pembelian->panjang * 12500 * $ket_pembelian->jumlah_kertas )?> / <?=$ket_pembelian->jumlah_kertas?> source" disabled=""> 
                <?php endif ?>
                <?php if ($value->kategori != 3): ?>
                
                <input type="Text"  class="form-control" value="Rp. <?=number_format(($ket_pembelian->jenis_kertas * $ket_pembelian->jumlah_kertas ) )?> / <?=$ket_pembelian->jumlah_kertas?> source" disabled="">   
                <?php endif ?>
                    ...
                    <div class="col-md-12">
                      ...
                      <select class="form-control" name="jenis_kertas" id="jenis_kertas" required>
                        <option value="" disabled="">-Silahkan Pilih Jenis ui dan ux</option>
                          <?php  
                            if ($value->kategori == 1) { ?>
                        <option value="4000" <?php if ($ket_pembelian->jenis_kertas == "4000"): ?> selected="" <?php endif ?>>remote| Rp. 4,000 / 1 source</option>
                        <option value="3000" <?php if ($ket_pembelian->jenis_kertas == "3000"): ?> selected="" <?php endif ?>>custom sendiri | Rp. 3,000 / 1 source</option>
                        ...
                        <option value="25000" <?php if ($ket_pembelian->jenis_kertas == "25000"): ?> selected="" <?php endif ?>>remote| Rp. 4,000 / 1 source</option>
                        <option value="1000" <?php if ($ket_pembelian->jenis_kertas == "1000"): ?> selected="" <?php endif ?>>custom sendiri | Rp. 3,000 / 1 source</option>
